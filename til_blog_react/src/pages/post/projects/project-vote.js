      ...
      <div className="projectPost">
        <div>
          ...
          <p className="postText">
            ...
            뒤져가며 밤새 개발했습니다.
            <br />
            기억나는 것은 최종 발표 날 새벽에 CODESANDBOX를 사용해 실시간 공유
            코딩을 하면서 오류를 잡아내는 시간이었습니다.
            <br />
            <br />
            단어 선택이 적절한진 모르겠지만 전우애를 너무 느꼈고, 마지막
            문제(레이아웃 문제로 이미지가 원하는 곳에 위치하지 않음)를 해결했을
            때 다 같이 '주석'으로 외친 비명은 잊지 못하겠습니다 😂😂
            <br />
            <br />
            그리고 저는 이후로 리액트의 매력에 빠져 지금도 리액트를 가장
            좋아합니다.&#128152;
          </p>
        </div>
        <hr />
